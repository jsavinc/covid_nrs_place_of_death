...
```{r}
# TODO: deal with 2022 data here, now that it's 'historical'
...
There is a second sense of 'historical' here, which denotes cause of death figures for 2020 to 2022; these were only provided as 5-year averages for 2015-2019, whereas we have a per-cause breakdown from 2020 onwards - to combine these, a 5-year historical average needs to be recomputed using a combination of the 2015-2019 data and the 2020+ data (using weighted averages).
...
Because the data from July 2022 onwards are split up so that I load the 2020 and 2021 from different sources, I'll compute the **Note: I don't remember what came after this...**
