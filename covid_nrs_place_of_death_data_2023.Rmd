...
## Note: as of 16 Feb 2023, this returns a strange error
# TODO: if error persists, load data from the main report file instead?
...
weeks_available_2023 <- max(merged_deaths_age$week_number[merged_deaths_age$year==2023])
most_recent_date_available_2023 <- max(merged_deaths_age$date_w_c)
