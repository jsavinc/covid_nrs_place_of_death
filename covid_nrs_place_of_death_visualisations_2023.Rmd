...
(fig_map_home_deaths_increase_from_2020_la <-
  ...
  labs(x="", y="",
       ...
       caption = paste0(c(only_2023_text,source_nrs_text), collapse="\n"),
       fill = "Home death\nincrease relative\nto 2015-2019"
       ) +
  NULL)
...
(fig_map_covid_cases_from_2020_la <-
  ...
  labs(x="", y="",
       ...
       subtitle = "",
       caption = paste0(c(only_2023_text,crude_rate_text,source_phs_text), collapse="\n"),
...
fig_expected_home_deaths_regression <-
  ...
  labs(y = NULL, x = "Year (hypothetical)", title = "Increasing deaths at home", subtitle = str_wrap("Home deaths were on the increase before the pandemic.\nIf we assumed the same annual increases from 2015-2019 we wouldn't expect the pandemic levels of home deaths until 2031!", width = 90), caption = paste0(c(glue::glue("*Annual home deaths for 2023 extrapolated from data for weeks 1-{weeks_available_2023}"),source_nrs_text), collapse="\n"))
