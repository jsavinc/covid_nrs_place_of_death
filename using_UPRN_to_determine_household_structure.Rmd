...
number_of_household_members <-
  ...
  tidyr::complete(id_death = fake_deaths$id_death, fill = list(num_household_members = 0))

# chis_with_matching_uprn_episodic <- 
#   chi_with_matching_uprn %>%
#   select(id_chi, episode_id) %>%
#   mutate(next_episode_id = episode_id + 1) %>%
#   left_join(fake_chi, by = c("id_chi", "next_episode_id"="episode_id")) %>%
#   mutate(date_episode_end = replace_na(date_address_change, replace = ymd("2021-01-01")))
#   
