...
walk(
  .x = c(".pdf",".svg",".png"),
  .f = ~ggsave(filename = paste0(dir_outputs,"/figure_deaths_at_home",.x), plot = figure_deaths_at_home, width = 12, height = 9, dpi = 300)
)
...
We can use the yearly cumulative case count to group geographic areas by how many cases they've had
