...
(figure_annual_deaths_by_cause <-
  ...
  geom_col(aes(x = cause_of_death, fill = cause_of_death, y = deaths), position = "dodge", colour = "grey10") +
  geom_point(aes(x = cause_of_death, y = annual_deaths_mean), position = "dodge", colour = "grey10") +
