...
# datapasta::tribble_paste(tbl_recoded_place_of_death %>% select(place_of_death_recoded))
  ...
  mutate(place_of_death_recoded = factor(place_of_death_recoded, levels = levels(tbl_recoded_place_of_death$place_of_death_recoded)))  # needs to be factor with same levels, otherwise it messes up level order when added as geom_text later!
